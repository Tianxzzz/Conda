...
class TCL(nn.Module):
    ...
    def compute_src_dst_node_temporal_embeddings(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray,
        ...
        return src_node_features, dst_node_features, src_neighbor_node_ids, dst_neighbor_node_ids
    
    def encode(self,src_node_features:torch.Tensor, src_neighbor_node_ids: np.ndarray, dst_node_features: torch.Tensor, dst_neighbor_node_ids:np.ndarray):
